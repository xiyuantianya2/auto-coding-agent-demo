            ...
            <div className="mt-4 space-y-4 text-sm leading-relaxed text-zinc-300">
              ...
              <section className="space-y-2">
                ...
                <ul className="list-inside list-disc space-y-1.5 text-zinc-400 marker:text-zinc-600">
                  ...
                  <li>
                    <strong>连锁呈现</strong>：多波连锁会在盘面上<strong>分步展示</strong>
                    ——每一波依次经历「匹配高亮 → 消除过渡 → 重力下落与顶部补位」，波与波之间略有间隔以便辨认；
                    本步总分与胜负判定在<strong>整段连锁播放结束</strong>后一次性更新（与程序结算一致）。若系统开启「减弱动效」，将缩短或跳过逐格动画，直接显示本步终局盘面，结果与完整播放一致。
                  </li>
                </ul>
              </section>
            </div>
